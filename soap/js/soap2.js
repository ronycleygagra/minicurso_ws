...
function consultaclientefornecedor(value_cpf) {
    ...
    $.ajax({
        url: url_consultaclientefornecedor,
        type: "POST",
        dataType: "xml",
        data: strRequest,
        ...
        beforeSend: function(xhr) {
            xhr.setRequestHeader("SOAPAction", soapaction_consultaclientefornecedor)
        }
    });
    ...
    function OnSuccess(data, status){
        ...
        var resultado = data.getElementsByTagName(tagname)[0].childNodes[0].nodeValue;
